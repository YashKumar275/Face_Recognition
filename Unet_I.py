...
unmasked_path = "D:\tdl_6\tdl-project-sem-6/unmasked2/30000"
masked_path = "D:\tdl_6\tdl-project-sem-6/masked2/30000"
masked=[]
delete=[]
...
path="D:\tdl_6\tdl-project-sem-6/testing/testing.jpg"
img = cv2.imread(path)
img = cv2.resize(img,(224,224))
cv2.imwrite("D:\tdl_6\tdl-project-sem-6\abc.jpg",img)

path = "D:\tdl_6\tdl-project-sem-6/unmasked2/30000"
for i in os.listdir(path):
    try:
        img = cv2.imread( os.path.join(path,i) )
        img = cv2.resize(img,(224,224))
        cv2.imwrite("D:\tdl_6\tdl-project-sem-6/unmasked_dataset2/30000/"+str(i),img)
    except Exception as e:
        print(i)
        pass
...
path = "D:\tdl_6\tdl-project-sem-6/bluemask_binary"
pathh = "D:\tdl_6\tdl-project-sem-6/bluemask_binary_pros/"
for i in os.listdir(path):
...
masked_root = "D:\tdl_6\tdl-project-sem-6/11k-13k_masked"
binary_root = "D:\tdl_6\tdl-project-sem-6/11k-13k_binary"
...
pretrained = True
if pretrained:
    loaded_state = torch.load("D:\tdl_6\tdl-project-sem-6/bi_unet_42540.pth",map_location=torch.device('cpu'))
